...
import { Customer, ExtinguisherDetail, ExtinguisherFormRow } from '@/types';
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({
          ...
          certificate_no: data.customer.certificate_no,
          service_date: data.customer.service_date,
          expiry_duration: 12,
          expiry_date: data.customer.expiry_date,
          total_qty: data.customer.total_qty,
        });
        setExtinguishers(
          data.extinguishers.map((ext: ExtinguisherDetail) => ({
            id: String(ext.id),
      ...
      <div className="ml-[260px] p-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-card p-8">
            ...
            <p className="text-center text-gray-600 mb-8">Edit Customer Details</p>
